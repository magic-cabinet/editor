...
export const magicCabinetLayoutDefinition: NodeDefinition<typeof MagicCabinetLayoutNode> = {
  ...
  defaults: () => ({
    ...
    palette: 'sage-oak',
    // Mirrors the MVP default design (`design-generation.ts:39-49`): white
    // shaker, quartz, hardwood, no backsplash, no crown, no ceiling fillers.
    doorStyle: 'shaker',
    cabinetTexture: 'none',
    countertopMaterial: 'quartz',
    applianceDetail: true,
    crownMoldingEnabled: false,
    ceilingFillersEnabled: false,
    floorType: 'hardwood',
    backsplashMaterial: 'none',
  }),
  capabilities: {
